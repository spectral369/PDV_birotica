...
public class CerereScutireInfo extends HorizontalLayout
	implements RouterLayout, AfterNavigationObserver {
    private static final long serialVersionUID = 1L;
    public static final String NAME = "CerereScutireInfo";
    ...
    Button generate;
    CerereScutirePDF pdf;
    Map<String, String> map;
    private Binder<CerereScutireInfo> binder;

    public CerereScutireInfo() {
	content = new VerticalLayout();
	map = new HashMap<String, String>();
	binder = new Binder<CerereScutireInfo>(CerereScutireInfo.class);
	...
	IarbaTitle = new Button("Cerere Scutire", VaadinIcon.FILE_TEXT_O.create());
	...
	binder.forField(prenumeField).asRequired()
		...
		.bind(new ValueProvider<CerereScutireInfo, String>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public String apply(CerereScutireInfo source) {
			return null;
		    }
		}, new Setter<CerereScutireInfo, String>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(CerereScutireInfo bean, String fieldvalue) {
	...
	binder.forField(cnpField).asRequired()
		...
		.bind(new ValueProvider<CerereScutireInfo, BigInteger>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public BigInteger apply(CerereScutireInfo source) {
			return null;
		    }
		}, new Setter<CerereScutireInfo, BigInteger>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(CerereScutireInfo bean, BigInteger fieldvalue) {
	...
	binder.forField(nrZileField).asRequired().withConverter(new StringToIntegerConverter("Must be Integer"))
		.bind(new ValueProvider<CerereScutireInfo, Integer>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public Integer apply(CerereScutireInfo source) {
			return null;
		    }
		}, new Setter<CerereScutireInfo, Integer>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(CerereScutireInfo bean, Integer fieldvalue) {
	...
	binder.forField(dateField).asRequired()
		...
		.bind(new ValueProvider<CerereScutireInfo, LocalDate>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public LocalDate apply(CerereScutireInfo source) {
			return null;
		    }
		}, new Setter<CerereScutireInfo, LocalDate>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(CerereScutireInfo bean, LocalDate fieldvalue) {
	...
	generate.addClickListener(evt -> {
		...
		PDFCSCreator pdfcr =  new PDFCSCreator(map,Utils.getTimeStr());
	 	String fn =  pdfcr.getID();
	    
		 RouteConfiguration.forSessionScope().removeRoute(CerereScutirePDF.class);
	 	 RouteConfiguration.forSessionScope().setRoute(CerereScutirePDF.NAME, CerereScutirePDF.class);
	Map <String,String> sss =  new HashMap<String,String>();
	sss.put("tm", fn);
	
	UI.getCurrent().navigate("CerereScutire",QueryParameters.simple(sss));
