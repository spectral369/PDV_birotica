...
public class DeclaratiePePropriaRaspundereInfo extends CustomComponent implements View {
	...
	public DeclaratiePePropriaRaspundereInfo() {
		...
		backbtn.addClickListener(evt -> getUI().getNavigator().navigateTo("Index"));
		...
		generate.addClickListener(evt -> {
			...
			pdf = new DeclaratiePePropriaRaspunderePDF(map);
			getUI().getNavigator().navigateTo("DeclaratiePePropriaRaspunderePDF");
		});
		...
		getUI().getNavigator().addView("DeclaratiePePropriaRaspundereInfo", this);
