...
public class DeclaratiePePropriaRaspundereInfo extends HorizontalLayout
	implements RouterLayout, AfterNavigationObserver {
    private static final long serialVersionUID = 1L;
    public static final String NAME = "DeclaratiePePropriaRaspundereInfo";
    ...
    Button generate;
    DeclaratiePePropriaRaspunderePDF pdf;
    Map<String, String> map;
    private Binder<DeclaratiePePropriaRaspundereInfo> binder;

    public DeclaratiePePropriaRaspundereInfo() {
	content = new VerticalLayout();
	map = new HashMap<String, String>();
	binder = new Binder<DeclaratiePePropriaRaspundereInfo>(DeclaratiePePropriaRaspundereInfo.class);
	...
	IarbaTitle = new Button("Declaratie pe Propria Raspundere", VaadinIcon.FILE_TEXT_O.create());
	...
	binder.forField(prenumeField).asRequired()
		...
		.bind(new ValueProvider<DeclaratiePePropriaRaspundereInfo, String>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public String apply(DeclaratiePePropriaRaspundereInfo source) {
			return null;
		    }
		}, new Setter<DeclaratiePePropriaRaspundereInfo, String>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(DeclaratiePePropriaRaspundereInfo bean, String fieldvalue) {
	...
	binder.forField(cnpField).asRequired()
		...
		.bind(new ValueProvider<DeclaratiePePropriaRaspundereInfo, BigInteger>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public BigInteger apply(DeclaratiePePropriaRaspundereInfo source) {
			return null;
		    }
		}, new Setter<DeclaratiePePropriaRaspundereInfo, BigInteger>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(DeclaratiePePropriaRaspundereInfo bean, BigInteger fieldvalue) {
	...
	binder.forField(nrZileField).asRequired().withConverter(new StringToIntegerConverter("Must be Integer"))
		.bind(new ValueProvider<DeclaratiePePropriaRaspundereInfo, Integer>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public Integer apply(DeclaratiePePropriaRaspundereInfo source) {
			return null;
		    }
		}, new Setter<DeclaratiePePropriaRaspundereInfo, Integer>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(DeclaratiePePropriaRaspundereInfo bean, Integer fieldvalue) {
	...
	binder.forField(dateField).asRequired()
		...
		.bind(new ValueProvider<DeclaratiePePropriaRaspundereInfo, LocalDate>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public LocalDate apply(DeclaratiePePropriaRaspundereInfo source) {
			return null;
		    }
		}, new Setter<DeclaratiePePropriaRaspundereInfo, LocalDate>() {

		    private static final long serialVersionUID = 1L;

		    @Override
		    public void accept(DeclaratiePePropriaRaspundereInfo bean, LocalDate fieldvalue) {
	...
	generate.addClickListener(evt -> {
		...
		PDFDPRCreator pdfcr =  new PDFDPRCreator(map,Utils.getTimeStr());
	 	String fn =  pdfcr.getID();
	    
		 RouteConfiguration.forSessionScope().removeRoute(DeclaratiePePropriaRaspunderePDF.class);
	 	 RouteConfiguration.forSessionScope().setRoute(DeclaratiePePropriaRaspunderePDF.NAME, DeclaratiePePropriaRaspunderePDF.class);
	Map <String,String> sss =  new HashMap<String,String>();
	sss.put("tm", fn);
	
	UI.getCurrent().navigate("DeclaratiePeProperiaRaspundere",QueryParameters.simple(sss));
